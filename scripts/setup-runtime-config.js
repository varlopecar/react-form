...
const config = {
    ...
    productionApiUrl: process.env.VITE_API_URL || 'https://backend-fa3gmrrog-varlopecars-projects.vercel.app',
...
function writeConfigFile() {
    ...
    console.log(`🔗 API URL: ${process.env.NODE_ENV === 'production' ? config.productionApiUrl : config.defaultApiUrl}`);
}
